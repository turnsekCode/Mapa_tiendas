...
export default function RoquetasDeMar({ markers, menu_list, ciudad, general }) {
    ...
    <>
      ...
      <Layout menu_list={menu_list} ciudad={ciudad}>
        <div itemScope itemType="http://schema.org/Organization">
          ...
          <meta
            itemProp="address"
            content="Carretera de Alicún, 22. Roquetas de Mar, Provincia de Roquetas de Mar, 04740"
          />
        </div>
