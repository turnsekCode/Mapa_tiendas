...
export default function Malaga({ markers, menu_list, ciudad, general }) {
    ...
    <>
      ...
      <Layout menu_list={menu_list} ciudad={ciudad}>
        <div itemScope itemType="http://schema.org/Organization">
          ...
          <meta
            itemProp="address"
            content="Calle Álamos, 40. Málaga, Provincia de Málaga, 29012"
          />
          <meta
            itemProp="address"
            content="Calle Camino Suárez 32. Málaga, Provincia de Málaga, 29011"
          />
          <meta
            itemProp="address"
            content="Av. de la Aurora, 18. Málaga, Provincia de Málaga, 29002"
          />
        </div>
