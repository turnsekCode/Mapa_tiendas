...
export default function Castellon({ markers, menu_list, ciudad, general }) {
    ...
    <>
      ...
      <Layout menu_list={menu_list} ciudad={ciudad}>
        <div itemScope itemType="http://schema.org/Organization">
          ...
          <meta
            itemProp="address"
            content="Calle de Bayer, 10. Castellón, Provincia de Castellón, 12002"
          />
        </div>
        <article className={styles.main}>
          <BreadcrumbsTiendas
            ...
            urlNombreCiudad="https://quickgold.es/tiendas/compro-oro-castellon"
