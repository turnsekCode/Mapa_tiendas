...
export default function Murcia({ markers, menu_list, ciudad, general }) {
    ...
    <>
      ...
      <Layout menu_list={menu_list} ciudad={ciudad}>
        <div itemScope itemType="http://schema.org/Organization">
          ...
          <meta
            itemProp="address"
            content="Calle Escultor Roque López, 4. Murcia, Provincia de Murcia, 30008"
          />
          <meta
            itemProp="address"
            content="Alameda de Colón, 6. Murcia, Provincia de Murcia, 30002"
          />
        </div>
