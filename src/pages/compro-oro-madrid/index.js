...
export default function Madrid({ markers, menu_list, ciudad, general }) {
    ...
    <>
      ...
      <Layout menu_list={menu_list} ciudad={ciudad}>
        <div itemScope itemType="http://schema.org/Organization">
          ...
          <meta
            itemProp="address"
            content="Calle de Alcalá, 184 D. Madrid, Provincia de Madrid, 28028"
          />
          <meta
            itemProp="address"
          ...
          <meta
            itemProp="address"
            content="Calle de Guzmán el Bueno, 57. Madrid, Provincia de Madrid, 28015"
          />
          <meta
            itemProp="address"
            content="Calle de Alcalá 351. Madrid, Provincia de Madrid, 28027"
          />
          <meta
            itemProp="address"
          ...
          <meta
            itemProp="address"
            content="Calle Antonio López, 30. Bajo D. Madrid, Provincia de Madrid, 28019"
          />
          <meta
            itemProp="address"
