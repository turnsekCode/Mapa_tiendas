...
// Exports
module.exports = {
	"contenedorHtml": "htmlGeneral_contenedorHtml__V4osI"
};
...
// EXTERNAL MODULE: ./src/componentes/ComponenteHTML/Html.js
var Html = __webpack_require__(38);
// EXTERNAL MODULE: ./src/componentes/ComponenteHTMLGeneral/htmlGeneral.module.css
var htmlGeneral_module = __webpack_require__(2356);
var htmlGeneral_module_default = /*#__PURE__*/__webpack_require__.n(htmlGeneral_module);
;// CONCATENATED MODULE: ./src/componentes/ComponenteHTMLGeneral/HtmlGeneral.js



const HtmlGeneral = ({ general  })=>{
    return /*#__PURE__*/ jsx_runtime_.jsx("section", {
        className: (htmlGeneral_module_default()).contenedorHtml,
        dangerouslySetInnerHTML: {
            __html: general?.acf?.html
        }
    });
};
/* harmony default export */ const ComponenteHTMLGeneral_HtmlGeneral = (HtmlGeneral);

;// CONCATENATED MODULE: ./src/componentes/ComponentesPaginasCiudad/seccionTres/SeccionTres.js
...
const SeccionTres = ({ ciudad , general  })=>{
    let html;
    if (ciudad?.acf?.html === "") {
        html = /*#__PURE__*/ jsx_runtime_.jsx(ComponenteHTMLGeneral_HtmlGeneral, {
            general: general
        });
    } else if (general?.acf?.html === "") {
        html = /*#__PURE__*/ jsx_runtime_.jsx(Html/* default */.Z, {
            ciudad: ciudad
        });
    } else {
        html = /*#__PURE__*/ jsx_runtime_.jsx(Html/* default */.Z, {
